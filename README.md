...
In this repository I will highlight my hands-on practice, reports based on SOC analyst simulations from the learning platform LetsDefend.io. These exercises will focus on analyzed alerts, validated IOC, and documented findings.
...
| SOC120   |  Phishing Email      | False positive — Phishing Email Detected| [View Report](phishing-analysis/SOC120_Phishing_Mail_Internal_to_Internal.md) |
